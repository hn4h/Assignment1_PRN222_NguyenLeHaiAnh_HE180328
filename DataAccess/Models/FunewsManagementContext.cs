...
namespace NguyenLeHaiAnh_HE180328_Assignment1.DataAccess.Models
{
    ...
    public partial class FunewsManagementContext : DbContext
    {
        ...
        {
            // Only configure the DbContext here if no options have been provided by DI.
            // This prevents hard-coded or file-based settings from overriding environment
            // variables (for example, the Docker-provided ConnectionStrings__DefaultConnection).
